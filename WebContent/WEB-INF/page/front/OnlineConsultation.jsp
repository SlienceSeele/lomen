...
<div class="div_body">
    ...
    <div class="div_wid1100">
      ...
      <div class="div_ul_menu menu">
        <ul>
            ...
            <li class="current"><a href="${contextPath}/front/OnlineConsultation">在线咨询</a></li>
  ...
  <div class="div_back_yun">
    <div class="div_zcxg_dz">在线咨询 <img src="${contextPath}/static/lm/images/zxzxtp.png" width="90" height="90"  alt=""/></div>
    <div class="div_xxk">
  ...
  <div class="div_wid1100 position">
    <div class="div_dx">
      <div class="div_left_xw"><a href="javascript:void(0)" class="xz">在线咨询</a></div>
    </div>
    <div class="div_3gdt">
      <ul>
        <li>
          ...
          <figure>
            <div class="div_xx"><img src="${contextPath}/static/lm/images/cslgdx.png" width="300" height="300"  class="pic" alt=""/></div>
            <figcaption><span>长沙理工大学</span> </figcaption>
             
          </figure>
        </li>
        <li class="mar_lr_50"> <figure>
            <div class="div_xx"><img src="${contextPath}/static/lm/images/zndx.png" width="300" height="300"  class="pic" alt=""/></div>
            <figcaption> <span>中南大学</span> </figcaption>
          </figure></li>
        <li>
          <figure>
            <div class="div_xx"><img src="${contextPath}/static/lm/images/hndx.png" width="300" height="300"  class="pic" alt=""/></div>
            <figcaption> <span>河南大学</span> </figcaption>
          </figure>
        </li>
       <li>
          <figure>
