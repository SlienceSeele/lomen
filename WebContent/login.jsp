...
<head>
    ...
    <meta charset="utf-8"/>
    <title>龙门网后台 - 登录</title>

    <meta name="description" content="龙门网后台 |登录页面"/>
    ...
    <div class="footer">
        <div class="footer-inner">
            ...
            <div class="footer-content-nobordertop">
                <span class="blue bolder">爱维创思&nbsp;&copy;&nbsp;2015-2017</span>
            </div>
            <!-- /section:basics/footer -->
        </div>
    </div>
...
<script type="text/javascript"
        src="${contextPath}/static/dist/js/date-time/locales/bootstrap-datepicker.zh-CN.min.js"></script>
